...
import { Users, Ticket, RefreshCw, Clock } from "lucide-react";
    ...
    <PublicLayout>
      <div className="container py-12 md:py-20 max-w-lg mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Queue Status</h1>
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-7xl md:text-8xl font-extrabold text-primary animate-pulse-soft">
                {queue.currentToken}
              </p>
            </motion.div>
